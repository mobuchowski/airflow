...
from airflow.providers.openlineage.plugins.extractors.sql_execute_query import (
    get_sql_execute_query_extractor,
    sql_extractors,
)
from airflow.providers.openlineage.plugins.utils import import_from_string, try_import_from_string
    ...
    filter(
        ...
        [
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.postgres_extractor.PostgresExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.mysql_extractor.MySqlExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.bigquery_extractor.BigQueryExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.great_expectations_extractor.GreatExpectationsExtractor'  # noqa: E501
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.snowflake_extractor.SnowflakeExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.python_extractor.PythonExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.bash_extractor.BashExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.redshift_sql_extractor.RedshiftSQLExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.redshift_data_extractor.RedshiftDataExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.trino_extractor.TrinoExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.athena_extractor.AthenaExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.sftp_extractor.SFTPExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.ftp_extractor.FTPExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.sagemaker_extractors.SageMakerProcessingExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.sagemaker_extractors.SageMakerTrainingExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.sagemaker_extractors.SageMakerTransformExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.s3_extractor.S3CopyObjectExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.s3_extractor.S3FileTransformExtractor'
            ),
            try_import_from_string(
                'airflow.providers.openlineage.plugins.extractors.gcs_extractor.GCSToGCSExtractor'
            ),
        ],
    )
)
...
_extractors += get_check_extractors(
    try_import_from_string(
        'airflow.providers.openlineage.plugins.extractors.sql_extractor.SqlExtractor'
    )
)
