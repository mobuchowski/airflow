...
from airflow.providers.openlineage.extractors.python_extractor import PythonExtractor
...
def test_extraction_without_on_complete():
    extractor = ExtractorManager().get_extractor_class(OperatorWihoutComplete)
    assert extractor is DefaultExtractor
...
def test_extraction_without_on_start():
    extractor = ExtractorManager().get_extractor_class(OperatorWihoutStart)
    assert extractor is DefaultExtractor
