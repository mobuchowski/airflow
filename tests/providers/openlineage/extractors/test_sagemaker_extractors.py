...
from airflow.providers.openlineage.extractors.sagemaker_extractors import (
...
class TestSageMakerProcessingExtractor(TestCase):
    ...
    @mock.patch("airflow.providers.openlineage.extractors.sagemaker_extractors.generate_s3_dataset")
